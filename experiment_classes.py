...
class WrongIngTest:
    def __init__(self, transcript, num_steps, df_row, actor_specs, max_recipes=None, add_ingredients=False, augmented_ingredients=None):
    ...
    def perturb_recipe(self, include_r1=True, add_ingredients=False):
        ...
        for variable_name in self.variable_ingredients:
            ...
            if variable_name in self.transcript:
                ...
                if self.max_recipes and len(unused_ings) >= self.max_recipes - 1:
                    break
